...
type StorageConfig struct {
	...
	AliyunRegion   string `env:"ALIYUN_OSS_REGION"`
	...
	AliyunStsRole  string `env:"ALIYUN_OSS_STS_ROLE_ARN"`
	AliyunStsTTL   int    `env:"ALIYUN_OSS_STS_TTL_SECONDS" envDefault:"900"`
}
